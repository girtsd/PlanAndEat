        ...
        <div id="main">
            ...
            <div id="page">
                ...
                <?php 
                    ...
                    $sql = "select r.Recipe_id, r.RecipeName, r.Description, c.Unit, c.Amount, p.ProductName, p.Calories  
                            from Recipes r, Components c, Products p
                            where c.Recipe_id = r.Recipe_id
                            and p.Product_id = c.Product_id
                            order by r.Recipe_id LIMIT $start_from, 20"; 
...
//}
                while ($row = mysqli_fetch_assoc($rs_result)) { 
                           ...
                           echo "<td>".$row["Unit"]."</td>";                           
                           echo "<td><a href=recipe_edit.php?id=".$row['Recipe_id'].">update</a></td>";
                           echo "</tr>";
