...
<?php
    ...
    echo '<option value="">'.'--- Please Select Recipe ---'."</option>";
...
?>            
            ...
            <?php
                echo "<table>";
                echo "<tr><th>Edienreize</th><th>Pirmdiena</th><th>Otrdiena</th><th>Treðdiena</th><th>Ceturtdiena</th><th>Piektdiena</th><th>Sestdiena</th><th>Svçtdiena</th></tr>";
                ...
                $row = mysqli_fetch_assoc($result);
                    ...
                    echo "<td>".menu_droplist($row["Sestdiena"])."</td>";
                    echo "<td>".menu_droplist($row["Svetdiena"])."</td>";
                   echo "</tr>";
                echo "</table>";        
            ?>
             <p> </p>
        ...
        <form action="kalendarsv4.php">
            ...
            <a href="recipe_edit.php"> Update Recipe</a>
     </div>
</div>
    <?php
